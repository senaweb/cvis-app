...
@section('content')
<div class="container">
    <div class="row position-in-between-top-center justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="organization_id" class="col-md-4 col-form-label text-md-right">{{ __('Organization Unit') }}</label>
