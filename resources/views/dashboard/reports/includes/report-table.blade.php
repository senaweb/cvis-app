    ...
    @else
        <div class="my-6">
            <div class="report-card border p-3">
                <h5 class="text-center pb-5" style="text-decoration:underline">
                    Centralised Vehicle Incident System (cVIS) as at {{ $incidents[0]->created_at->format('d/m/Y') }}
                </h5>
            <div class="row">
                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    {{-- @if(request()->is('incidents')) Showing 1 to 10 of 10 entries <div class="float-right">{{ $incidents->links() }}</div> @endif --}}
                                </div>
                            </div>
                        </div>
                    </div>
                    <strong><div class="float-right"> Total Incidents: {{ $incidentsCount }}</div></strong>
            Showing 1 to 10 of 10 entries <div class="text-center">{{ $incidents->links() }}</div>
            </div>
        </div>
    @endif
@endif